...
import com.example.finalproject.data.local.NewsContract.ChannelEntity;
import com.example.finalproject.data.local.NewsContract.CommentEntity;
import com.example.finalproject.data.local.NewsContract.ImageEntity;
import com.example.finalproject.data.local.NewsContract.NewsEntity;

import static com.example.finalproject.Constant.QUREY_AMOUNT;
